...
@section('title', 'Harmony Interiors || tecture || tecture Laravel  Template')
@push('styles') 
...
@section('content')
    <x-strickyHeaderTwo />
    <x-page-header title="Harmony Interiors" subtitle="Harmony Interiors" />
                    ...
                    <div class="col-xl-8 col-lg-7">
                        <div class="service-details__right">
                            <div class="service-details__img">
                                <img src="{{ asset('assets/images/services/service-details-img-3.jpg') }}" alt="">
                            </div>
                            <h3 class="service-details__title-1">Harmony Interiors</h3>
