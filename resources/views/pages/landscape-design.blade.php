...
@section('title', 'Landscape Design || tecture || tecture Laravel  Template')
@push('styles') 
...
@section('content')
    <x-strickyHeaderTwo />
    <x-page-header title="Landscape Design" subtitle="Landscape Design" />
                    ...
                    <div class="col-xl-8 col-lg-7">
                        <div class="service-details__right">
                            <div class="service-details__img">
                                <img src="{{ asset('assets/images/services/service-details-img-5.jpg') }}" alt="">
                            </div>
                            <h3 class="service-details__title-1">Landscape Design</h3>
