...
@section('title', 'Evolve Space Designs || tecture || tecture Laravel  Template')
@push('styles') 
...
@section('content')
    <x-strickyHeaderTwo />
    <x-page-header title="Evolve Space Designs" subtitle="Evolve Space Designs" />
                ...
                <div class="row">
                    ...
                    <div class="col-xl-8 col-lg-7">
                        <div class="service-details__right">
                            ...
                            <h3 class="service-details__title-1">Evolve Space Designs</h3>
